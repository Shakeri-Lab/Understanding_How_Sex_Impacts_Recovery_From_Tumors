...
class Paths():
    ...
    def __init__(self):
        ...
        # outputs
        self.series_of_Ensembl_IDs_and_HGNC_symbols = self.outputs_of_data_loading / "data_frame_of_Ensembl_IDs_and_HGNC_symbols.csv"
        ...
        # outputs
        self.data_frame_of_top_diagnoses_CD8_signatures_and_statistics = self.outputs_of_cd8_analysis / "data_frame_of_top_diagnoses_CD8_signatures_and_statistics.csv"
